...
var basicModelTest =
{
	"Construction (Structure)":
		function()
		{
			...
			var preinit = ["structure"]._construct({a: 123, b: "456"});
			
			console.assert( preinit instanceof Object);
			console.assert( preinit.a == 123);
			console.assert( preinit.b == "456");
			
			var preinitTagged = ["?anything", "structure"]._construct({a: 123, b: "456"});
	...
	"Construction (List)":
		function()
		{
			...
			var preinit = ["list"]._construct([1,2,3]);
			...
			var preinitTagged = ["?anything", "list"]._construct([1,2,3]);
